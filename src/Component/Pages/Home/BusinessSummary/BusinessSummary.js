      ...
      <div className="summary-card grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-10 mt-20 mb-20">
        <div className="card  bg-base-100 shadow-lg">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title text-secondary text-4xl">72</h2>
            <p className="text-3xl text-primary">countries </p>
          </div>
        </div>
        <div className="card  bg-base-100 shadow-lg ">
          <figure className="px-10 pt-10">
            <FaDesktop className="text-primary text-6xl" />
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-secondary text-4xl">535+</h2>
            <p className="text-3xl text-primary">complete projects+</p>
          </div>
        </div>
        <div className="card  bg-base-100 shadow-lg">
          <figure className="px-10 pt-10">
            <FaPeopleCarry className="text-primary text-6xl" />
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-secondary text-4xl">230+</h2>
            <p className="text-3xl text-primary">happy clients+ </p>
          </div>
        </div>
        <div className="card  bg-base-100 shadow-lg">
          <figure className="px-10 pt-10">
            <FaHandSparkles className="text-primary text-6xl" />
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-secondary text-4xl">432+</h2>
