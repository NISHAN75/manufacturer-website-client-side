  ...
  return (
    <Carousel>
      <div className="relative">
        ...
        <div className="banner-info absolute text-left top-10 lg:top-64 left-10 lg:left-20">
          <h2 className="text-xl lg:text-6xl md:text-4xl font-bold text-emerald-500  lg:mb-8">
            Distance means so little
            <br /> when you want to reach.
          </h2>
          <p className="hidden  sm:block md:block lg:block text-xxl lg:text-xl font-bold text-black">
