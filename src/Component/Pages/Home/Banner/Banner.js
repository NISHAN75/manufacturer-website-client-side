  ...
  return (
    ...
    <div className="relative">
        ...
        <div className="banner-info absolute text-left top-64  left-20">
          <h2 className="text-6xl font-bold text-emerald-500 mb-8">Distance means so little<br/>  when you want to reach.</h2>
          <p className="text-xl font-bold text-black">Cycles are our best friends, in fact not only ours but best for mother Earth as<br/> well. We ride cars and bikes all day and every day to do our daily household<br/> activities or to go to our work. But we must take out time to ride a bicycle too!</p>
          <button class="btn btn-primary mt-5 px-10 text-white hover:bg-white hover:text-black">Warning</button>
        </div>
    </div>
    <div className="relative">
